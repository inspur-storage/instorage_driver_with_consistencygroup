...
class InStorageMCSReplication(object):
    ...
    def factory(driver):
        ...
        stretch = driver.configuration.instorage_mcs_stretched_cluster_partner
        if stretch:
            return InStorageMCSReplicationStretchedCluster(driver)
    ...
    def reenable_replication(self, volume):
        ...
        This is not implemented in the InStorageMCSReplicationStretchedCluster,
        as the InStorage backend is responsible for automatically resuming
        mirroring when stopped.
        """
        pass


class InStorageMCSReplicationStretchedCluster(InStorageMCSReplication):
    """Support for InStorage/MCS stretched cluster mode replication.
    ...
    def __init__(self, driver, replication_target=None):
        super(InStorageMCSReplicationStretchedCluster, self).__init__(driver)
    ...
    def get_replication_status(self, volume):
        ...
        copies = self.driver._assistant.get_vdisk_copies(vdisk)
    ...
    def create_replica(self, ctxt, volume, vol_type=None):
        ...
        dest_pool = conf.instorage_mcs_stretched_cluster_partner
    ...
    def delete_replica(self, volume):
        ...
        if secondary:
            self.driver._assistant.rm_vdisk_copy(volume['name'],
                                                 secondary['copy_id'])
        else:
    ...
    def test_replica(self, tgt_volume, src_volume):
        ...
        if copies['secondary']:
            ...
            self.driver._assistant.create_copy(src_volume['name'],
                                               tgt_volume['name'],
                                               src_volume['id'],
    ...
    def promote_replica(self, volume):
        ...
        if copies['secondary']:
            ...
            self.driver._assistant.change_vdisk_primary_copy(volume['name'],
                                                             copy_id)
        else:
...
class InStorageMCSReplicationAsyncCopy(
        InStorageMCSReplicationStretchedCluster):
...
class InStorageMCSReplicationSyncCopy(
        InStorageMCSReplicationAsyncCopy):
    ...
    def __init__(self, driver, replication_target=None, target_assistant=None):
        super(InStorageMCSReplicationSyncCopy, self).__init__(
            driver, replication_target, target_assistant)
