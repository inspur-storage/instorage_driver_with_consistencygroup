...
instorage_mcs_opts = [
    ...
    cfg.BoolOpt('instorage_mcs_multihostmap_enabled',
                default=True,
...
class InStorageMCSCommonDriver(san.SanDriver,
                               driver.ManageableVD,
                               driver.MigrateVD,
    ...
    def do_setup(self, ctxt):
        ...
        self.replication = instorage_rep.InStorageMCSReplication.factory(self)
    ...
    def create_consistencygroup(self, context, group):
        ...
        Inspur InStorage will create CG until cg-snapshot creation,
    ...
    def create_consistencygroup_from_src(self, context, group, volumes,
        ...
        self._assistant.create_lc_consistgrp(cg_name)
        timeout = self.configuration.instorage_mcs_localcopy_timeout
        model_update, snapshots_model = (
            self._assistant.create_cg_from_source(group,
                                                  cg_name,
                                                  sources,
                                                  volumes,
                                                  self._state,
    ...
    def delete_consistencygroup(self, context, group, volumes):
        ...
        Inspur InStorage will delete the volumes of the CG.
        """
    ...
    def create_cgsnapshot(self, ctxt, cgsnapshot, snapshots):
        ...
        model_update, snapshots_model = (
            self._assistant.run_consistgrp_snapshots(cg_name,
                                                     snapshots,
                                                     self._state,
                                                     self.configuration,
                                                     timeout))
    ...
    def delete_cgsnapshot(self, context, cgsnapshot, snapshots):
        ...
        model_update, snapshots_model = (
            self._assistant.delete_consistgrp_snapshots(cg_name,
                                                        snapshots))
        ...
        try:
            ...
            if pool_data:
                ...
                multiattach = (self.configuration.
                               instorage_mcs_multihostmap_enabled)
                pool_stats = {
...
class InStorageAssistant(object):
    ...
    def replication_licensed(self):
        ...
        try:
            ...
            if product_key in instorage_const.REP_CAP_DEVS:
                return True
    ...
    def build_default_opts(config):
        ...
        cluster_partner = config.instorage_mcs_stretched_cluster_partner
        opt = {'rsize': config.instorage_mcs_vol_rsize,
               ...
               'replication': False,
               'nofmtdisk': config.instorage_mcs_vol_nofmtdisk}
        return opt
    ...
    def create_cg_from_source(self, group, lc_consistgrp,
        ...
        LOG.debug('Enter: create_cg_from_source: cg %(cg)s'
                  ...
                  {'cg': lc_consistgrp, 'source': sources, 'target': targets})
        model_update = {'status': fields.ConsistencyGroupStatus.AVAILABLE}
        ctxt = context.get_admin_context()
        try:
    ...
    def mkvdiskhostmap(self, host, vdisk, lun, multihostmap):
        ...
        try:
            ...
            if (not multihostmap and hasattr(ex, 'message') and
                ...
                LOG.error(_LE('instorage_mcs_multihostmap_enabled is set '
